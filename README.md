...
Notifikasi hanya berisi pengingat umum, meminta suara notifikasi sistem beserta pola getaran `[250, 120, 250]`, dan membuka Forge saat ditekan. Dukungan pola getaran berbeda antar-browser; iPhone mengendalikan suara serta haptic melalui pengaturan sistem dan Focus. Service worker tidak memutar alarm berulang atau menyimpan halaman, token login, dan media pribadi. Notifikasi tetap bergantung pada internet dan dapat terlambat sehingga bukan jaminan alarm tepat detik. Bila start/cancel gagal, UI memberi peringatan. Pengiriman dibatasi tiga percobaan dalam dua menit, TTL push 60 detik, dan satu tag per timer. Catatan timer dibersihkan setelah tujuh hari, log Cron Forge setelah satu hari. Refresh menghilangkan hitung mundur lokal; jadwal yang sudah diterima server tetap dapat mengirim notifikasi.
